...
var obstacleImage1, obstacleImage2, obstacleImage3, obstacleImage4, obstacleImage5, obstacleImage6, obstaclesGroup;
function preload(){
...
function draw() {
  ...
  //scoring
  var count = Math.round(getFrameRate()/4);
  ...
  camera.position.y=trex.position.y-50
